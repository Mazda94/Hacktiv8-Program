...
// DEKLARASI `number`
// DEKLARASI `asterisk`
// SET `number` SAMA DENGAN `numbers` SLICE `numbers` LENGTH-5 SAMPAI DENGAN `numbers` LENGTH
// SET `asterisk` SAMA DENGAN `numbers` INDEX[0] SAMPAI DENGAN `numbers` LENGTH-5
